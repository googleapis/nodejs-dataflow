...
describe('v1beta3.TemplatesServiceClient', () => {
    ...
    describe('createJobFromTemplate', () => {
        it('invokes createJobFromTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateJobFromTemplateRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('CreateJobFromTemplateRequest', ['location']);
    ...
    describe('launchTemplate', () => {
        it('invokes launchTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('LaunchTemplateRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('LaunchTemplateRequest', ['location']);
            request.location = defaultValue2;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&location=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getTemplate', () => {
        it('invokes getTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTemplateRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetTemplateRequest', ['location']);
            request.location = defaultValue2;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&location=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
