...
describe('v1beta3.JobsV1Beta3Client', () => {
    ...
    describe('checkActiveJobs', () => {
        it('invokes checkActiveJobs without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.checkActiveJobs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('snapshotJob', () => {
        it('invokes snapshotJob without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.snapshotJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listJobs', () => {
        ...
        it('uses async iteration with listJobs with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.dataflow.v1beta3.ListJobsRequest());const expectedError = new Error('expected');
    ...
    describe('aggregatedListJobs', () => {
        it('invokes aggregatedListJobs without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.aggregatedListJobs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
