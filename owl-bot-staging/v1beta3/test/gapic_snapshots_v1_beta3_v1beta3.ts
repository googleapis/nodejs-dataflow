...
describe('v1beta3.SnapshotsV1Beta3Client', () => {
    ...
    describe('getSnapshot', () => {
        it('invokes getSnapshot without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetSnapshotRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetSnapshotRequest', ['location']);
            request.location = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetSnapshotRequest', ['snapshotId']);
    ...
    describe('deleteSnapshot', () => {
        it('invokes deleteSnapshot without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteSnapshotRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteSnapshotRequest', ['location']);
            request.location = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteSnapshotRequest', ['snapshotId']);
            request.snapshotId = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&location=${defaultValue2}&snapshot_id=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listSnapshots', () => {
        it('invokes listSnapshots without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListSnapshotsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListSnapshotsRequest', ['location']);
            request.location = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('ListSnapshotsRequest', ['jobId']);
