...
describe('v1beta3.MetricsV1Beta3Client', () => {
    ...
    describe('getJobExecutionDetails', () => {
        ...
        it('uses async iteration with getJobExecutionDetails with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.dataflow.v1beta3.GetJobExecutionDetailsRequest());const expectedError = new Error('expected');
    ...
    describe('getStageExecutionDetails', () => {
        ...
        it('uses async iteration with getStageExecutionDetails with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.dataflow.v1beta3.GetStageExecutionDetailsRequest());const expectedError = new Error('expected');
