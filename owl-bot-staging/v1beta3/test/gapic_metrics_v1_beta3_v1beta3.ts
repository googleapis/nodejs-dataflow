...
describe('v1beta3.MetricsV1Beta3Client', () => {
    ...
    describe('getStageExecutionDetails', () => {
        it('invokes getStageExecutionDetails without error', async () => {
            ...
            request.jobId = '';
            request.stageId = '';
            const expectedHeaderRequestParams = "project_id=&location=&job_id=&stage_id=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
        ...
        it('uses async iteration with getStageExecutionDetails with error', async () => {
            ...
            request.jobId = '';
            request.stageId = '';
            const expectedHeaderRequestParams = "project_id=&location=&job_id=&stage_id=";const expectedError = new Error('expected');
