...
describe('v1beta3.MetricsV1Beta3Client', () => {
    ...
    describe('getJobMetrics', () => {
        it('invokes getJobMetrics without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetJobMetricsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetJobMetricsRequest', ['location']);
            request.location = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetJobMetricsRequest', ['jobId']);
    ...
    describe('getJobExecutionDetails', () => {
        it('invokes getJobExecutionDetails without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetJobExecutionDetailsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetJobExecutionDetailsRequest', ['location']);
            request.location = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetJobExecutionDetailsRequest', ['jobId']);
            request.jobId = defaultValue3;
    ...
    describe('getStageExecutionDetails', () => {
        it('invokes getStageExecutionDetails without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetStageExecutionDetailsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetStageExecutionDetailsRequest', ['location']);
            request.location = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetStageExecutionDetailsRequest', ['jobId']);
            request.jobId = defaultValue3;
            const defaultValue4 =
              getTypeDefaultValue('GetStageExecutionDetailsRequest', ['stageId']);
